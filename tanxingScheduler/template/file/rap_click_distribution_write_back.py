...
click_distribution_file_url = sys.stdin.readline().strip()
insertion = 'insert into click_distribution(task_id, click_distribution_file_url, insert_datetime, update_datetime ) values ("' + sys.argv[1] + '","' + click_distribution_file_url + '",' + cur_time + ' ,'+ cur_time + ' )'
