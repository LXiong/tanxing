...
##*************************************************************************/
##
## @file hot_question_global_write_back.py
...
cur = conn.cursor();
insertion = "insert into hot_question(task_id, range_type, question, pv, insert_datetime, update_datetime ) values (" + task_id + ", 'global', %s, %s, " + cur_time + " ,"+ cur_time + " )"
