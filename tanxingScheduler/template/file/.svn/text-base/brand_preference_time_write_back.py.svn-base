...
##*************************************************************************/
##
## @file brand_preference_time_write_back.py
...
cur = conn.cursor();
insertion = "insert into brand_preference(task_id, analysis_mode, day_part, brand_category_id, brand_map_id, pv, insert_datetime, update_datetime ) values (" + task_id + ", 'by_day_part', %s, '0', %s, %s," + cur_time + " ,"+ cur_time + " )"
