...
query_trend_file_url = sys.stdin.readline().strip()

insertion = 'insert into query_trend(task_id, query_trend_file_url, insert_datetime, update_datetime ) values ("' + sys.argv[1] + '","' + query_trend_file_url + '",' + cur_time + ' ,'+ cur_time + ' )'
