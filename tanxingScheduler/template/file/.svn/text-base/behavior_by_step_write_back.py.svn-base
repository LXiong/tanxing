...
##*************************************************************************/
##
## @file behavior_by_step_write_back.py
...
cur = conn.cursor();
insertion = "insert into user_behavior_by_step(task_id, industry_id, step, step_datetime, step_type, behavior_value, page_view, insert_datetime, update_datetime ) values (" + sys.argv[1] + ", " + sys.argv[2] + ", %s, %s, %s, %s, %s, " + cur_time + " ,"+ cur_time + " )"
