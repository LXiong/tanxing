...
##*************************************************************************/
##
## @file behavior_origin_write_back.py
...
cur = conn.cursor();
insertion = "insert into user_behavior_original_path(task_id, industry_id, path_type, origin_path, snapshot_time, page_view, insert_datetime, update_datetime ) values ("+ sys.argv[1] +", " + sys.argv[2] + ", %s, %s, %s, %s, " + cur_time + " ,"+ cur_time + " )"
