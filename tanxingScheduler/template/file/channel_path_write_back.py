...
##*************************************************************************/
##
## @file channel_path_write_back.py
...
cur = conn.cursor();
insertion = "insert into user_visit_path_by_channel(task_id, industry_id, channel_path, user_count, insert_datetime, update_datetime ) values (" + sys.argv[1] + ", " + sys.argv[2] + ", %s, %s, " + cur_time + " ,"+ cur_time + ")"
